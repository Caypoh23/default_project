...
class _$_WeatherEntity implements _WeatherEntity {
  const _$_WeatherEntity({required this.temp, required this.humidity});
  ...
  @override
  String toString() {
    return 'WeatherEntity(temp: $temp, humidity: $humidity)';
  }
...
abstract class _WeatherEntity implements WeatherEntity {
  const factory _WeatherEntity(
      ...
      required final int humidity}) = _$_WeatherEntity;
