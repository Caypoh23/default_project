...
class _$_ThemeSwitcherState implements _ThemeSwitcherState {
  const _$_ThemeSwitcherState({required this.isLight});
  ...
  @override
  String toString() {
    return 'ThemeSwitcherState(isLight: $isLight)';
  }
...
abstract class _ThemeSwitcherState implements ThemeSwitcherState {
  const factory _ThemeSwitcherState({required final bool isLight}) =
